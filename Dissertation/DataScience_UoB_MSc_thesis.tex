...
\subsection{Paired contrast}
The single-arm confidence interval tests whether each arm differs from chance, but not whether two arms differ from each other. To test whether small differences between arms are real differences or within sampling noise, a paired bootstrap was used and computed for ROC-AUC, PR-AP and F1. 
