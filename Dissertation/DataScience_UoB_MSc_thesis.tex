...
[TO DO: two-class SVM, C=1.0 fixed, standardScaler on training folds, class-weighted, out of fold pooling]
Performance was measured by precision, recall, and F1. [TO DO: add out-of-fold pooling and ROC-AUC/PR-AUC; bootstrap CIs]
