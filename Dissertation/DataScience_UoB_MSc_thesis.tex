...
The noise level of each signal was measured by its MAD. All denoisers reduced the noise significantly relative to the raw signal \ref{tab:denoising quality}, with dense achieving the lowest MAD of 0.559 and wavelet the highest MAD of 2.253. When comparing peak-to-peak amplitude across the 177 target spikes, wavelet and dense denoising reduce the spike amplitude significantly, retaining only about 32\% and \%18 of the raw spike amplitude, respectively. Convolutional denoising, on the other hand, preserved the spike, retaining 54\% while reducing noise significantly. 
\begin{table}[htbp]
    \centering
    \begin{tabular}{lccc}
    \toprule
    Signal & MAD & Peak-toPeak amplitude & Spike retained \\
    \midrule
    Raw & 4.958 & 23.92 & 100\% \\
